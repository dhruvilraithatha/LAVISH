    ...
    <div class="login-box">
        <div class="white-box">
            <form class="form-horizontal form-material" id="loginform" method="post" action="#">
                ...
                <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                        <button onclick="fblogin()" class="btn btn-rounded waves-effect waves-light btn-facebook" type="button"><span class="btn-label"><i class="fa fa-facebook"></i></span><?php echo $lang['LOGINFACEBOOK']; ?></button>
                    </div>
                    <!--<div class="col-xs-12"><br>
                        <a href="javascript:void(0)" id="to-recover" class="btn btn-rounded waves-effect waves-light btn-googleplus" ><span class="btn-label"><i class="fa fa-user"></i></span><?php /*echo $lang['LOGINGUEST']; */?></a>
                    </div>-->
                </div>
...
<script type="text/javascript">
    ...
    function fblogin()
    {
        var newWin = window.open("social_login/fblogin.php", "fblogin", 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, copyhistory=no,display=popup, width='+w+', height='+h+', top='+top+', left='+left);
    }
