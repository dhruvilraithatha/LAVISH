				...
				<table class="forums-table">
					...
					<tbody>
						<?php
							...
							$query="SELECT * FROM thread_topic WHERE thread_id=$thread_id ORDER BY `thread_topic`.`thread_topic_type` ASC;";
							...
							while ($row=mysqli_fetch_assoc($result)) {
								...
								if ($started_by!=NULL) {
									$query_for_selecting_user_details="SELECT * FROM user WHERE user_id=$started_by;";
									...
									while ($row_for_user_details=mysqli_fetch_assoc($result_for_selecting_user_details)) {
										$thread_topic_user_name=$row_for_user_details['uname'];
										$thread_topic_user_image=$row_for_user_details['profile_pic'];
									}
								}
					...
					<tr>
						<td class="forum">
							<div class="forum-item">
								<img src="images/<?php echo $topic_image; ?>" alt="thread" height="42" width="42">
								<div class="content">
									<a href="thread_topic_post.php?thread_id=<?php echo $thread_id; ?>&topic_id=<?php echo $topic_id; ?> " class="h6 title"><?php echo $topic_name; ?></a>
									<p class="text"><?php echo $topic_info; ?></p>
								</div>
							</div>
						</td>
						<td class="posts">
							<a href="#" class="h6 count"><?php echo $post_count; ?></a>
						</td>
					</tr>
					...
					<tr class="bg-smoke-light">
						<td class="forum">
							<div class="forum-item">
								...
								<div class="content">
									<a href="thread_topic_post.php?thread_id=<?php echo $thread_id; ?>&topic_id=<?php echo $topic_id; ?> "><?php echo $topic_name; ?></a>
								</div>
								<div class="author-started">
									<span>Started by:</span>
									<div class="author-thumb">
										<img src="../FRIEND_FEED/<?php echo $thread_topic_user_image;?>" alt="author">
									</div>
									<a href="#" class="h6 title"><?php $thread_topic_user_name; ?></a>
								</div>
							</div>
						</td>
						<td class="posts">
