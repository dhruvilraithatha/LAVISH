...
while($row=mysqli_fetch_assoc($result))
{
 ...
 ?>
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <form class="form-horizontal" role="form" method="post" action="includes/update-cat-sub.php?id=<?php echo $catid ?>">
                                            <div class="form-group">
                                                <h3 class="col-md-2">Category Name</h3><br><br>
                                                <p align="center">  <div class="col-md-10">
                                                  <input type="text" class="form-control" value="<?php echo $cat_name; ?>" name="c_name" required>
