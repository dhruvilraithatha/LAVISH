                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="card-box">
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <form class="form-horizontal " role="form" method="POST" action="Add_Thread_Code.php">
                                            <div class="form-group">
                                                <h3 class="col-md-2">Thread Name</h3><br><br>
                                                <p align="center">  <div class="col-md-10">
                                                  <input type="text" class="form-control" name="t_name" required >
                                                </div></p>
                                            </div>
                                            <div class="form-group">
                                                <h3 class="col-md-2">Thread Info</h3><br><br>
                                                <p align="center"><div class="col-md-10">
