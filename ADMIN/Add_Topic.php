                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="card-box">
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <form class="form-horizontal " role="form" method="POST" action="Add_Topic_Code.php">
                                            ...
                                            <div class="form-group">
                                                <h3 class="col-md-2">Topic Info</h3><br><br>
                                                <p align="center"><div class="col-md-10">
                                                    <textarea class="form-control" rows="5" name="t_content" required></textarea>
                                                </div></p>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                  <h3 >Topic Image</h3>
                                                        <input type="file" class="dropify"  name="t_image" required />
                                                </div>
                                              </div>
