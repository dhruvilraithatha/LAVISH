                                      ...
                                      <tbody>
                                        ...
                                        while($row=mysqli_fetch_assoc($result))
                                        {
                                          ...
                                          <tr >
                                              ...
                                              <td><?php echo $thread_id; ?></td>
                                              <td><?php echo $thread_name; ?></td>

                                              <td class="actions">

                                                <a href="Update_Thread.php?threadid=<?php echo $thread_id; ?>"><i class="fa fa-pencil " style="color:#21b61e"></i></a>
                                              <a href="Delete_Thread.php?threadid=<?php echo $thread_id; ?>"><i class="fa fa-trash-o" style="color:#ff5b5b; padding-left:9px;"></i></a></td>
